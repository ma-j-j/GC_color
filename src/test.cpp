...
void AlgorithmParameterView::BoardTypeInit()
{
    ...
    bga154Map.spinBoxMap["buckle_left_low"] = this->ui->spinBox_BGA154_buckle_left_low;
    ...
    wson8Map.spinBoxMap["buckle_left_low"] = this->ui->spinBox_WSON8_buckle_left_low;
    ...
    soic16Map.spinBoxMap["buckle_left_low"] = this->ui->spinBox_SOIC16_buckle_left_low;
